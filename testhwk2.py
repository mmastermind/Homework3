...
with open(working_file, 'r') as csvfile:
    ...
    #LIST INDEXES THAT DIDN'T WORK BECAUSE NEEDS FULL POSITION? - TO CHECK
    #print(d[5][25])
    #print(d[5][44])   
    #positionmax = d[5].index(int(d[3]))
    #positionmin = d[5].index(d[2])
    ...
    print(f'Total P/L for all the months is $ {d[0]}')
